...
def generate_output(customer_data_with_recommendations):
    print(customer_data_with_recommendations)


def generate_output_csv(customer_data_with_recommendations):
...
customer_data_with_recommendations = recommendation_system(customer_data_cleaned, outliers_data)

generate_output(customer_data_with_recommendations)

generate_output_csv(customer_data_with_recommendations)
